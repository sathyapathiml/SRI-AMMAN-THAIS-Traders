...
import type { Invoice, PettyExpense, StoreSettings, PrinterConfig } from '../types/pos';
import { Calendar, Printer, CheckCircle, X, DollarSign, Banknote, QrCode, CreditCard, Wallet, Calculator } from 'lucide-react';
